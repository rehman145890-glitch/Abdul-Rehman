    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl w-full max-w-lg shadow-2xl shadow-purple-500/20 text-center p-8">
        ...
        <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-4">
          Welcome to <span className="text-purple-600 dark:text-purple-500">{BRAND_CONFIG.appName}</span>!
        </h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Our new name reflects our mission: to be the central nexus that connects and streamlines your business operations.
        </p>
        <div className="text-left space-y-3 mb-8 text-gray-700 dark:text-gray-300">
          ...
          <p className="flex items-start"><span className="text-purple-500 dark:text-purple-400 mr-3 mt-1">✓</span> <strong>Offline & Secure:</strong> Your data is protected with 2-step verification and stored locally on your device.</p>
        </div>
        <button
          onClick={onClose}
